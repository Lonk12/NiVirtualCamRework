...
namespace NiUI
{
    ...
    internal class BitmapBroadcaster
    {
        ...
        public BitmapBroadcaster()
        {
            ...
            _file = MemoryMappedFile.CreateOrOpen("OpenNiVirtualCamFrameData", FileSize, MemoryMappedFileAccess.ReadWrite);
        ...
        public unsafe bool SendBitmap(Bitmap image)
        {
            ...
            lock (image)
            {
                ...
                var bitData = image.LockBits(new Rectangle(new Point(0, 0), image.Size), ImageLockMode.ReadOnly, PixelFormat.Format24bppRgb);
